...
function Confetti({ particleInput }) {
  var maxParticleCount =
    particleInput < 90 ? particleInput * 10 : particleInput * 400; //set max confetti count
  ...
  return (
    <div>
      <button onClick={stopConfettiInner}>Stop button</button>
    </div>
  );
}
